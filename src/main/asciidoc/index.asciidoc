= Payworks SuperHero API Documentation
:doctype: book
:compat-mode:
:page-layout!:
:toc: right
...
In the documented API were used 2 super heroes, Deadpool and Super López.
The database comes empty and ready to be populated.
